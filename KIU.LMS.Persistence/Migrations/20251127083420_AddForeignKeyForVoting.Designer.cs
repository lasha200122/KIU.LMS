...
namespace KIU.LMS.Persistence.Migrations
{
    ...
    [Migration("20251127083420_AddForeignKeyForVoting")]
    partial class AddForeignKeyForVoting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VotingOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SessionId", "FileRecordId")
                        .IsUnique();

                    b.ToTable("VotingOptions");
                });

            modelBuilder.Entity("VotingSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vote", b =>
                {
                    b.HasOne("VotingOption", "Option")
                        .WithMany("Votes")
                        .HasForeignKey("OptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VotingSession", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VotingOption", b =>
                {
                    b.HasOne("KIU.LMS.Domain.Entities.SQL.FileRecord", "FileRecord")
                        .WithMany()
