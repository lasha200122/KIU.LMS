        ...
        ILogger<StudentAnalyticsQueryHandler> _logger) : IRequestHandler<StudentAnalyticsQuery, Result<StudentAnalyticsDto>>
{
    public async Task<Result<StudentAnalyticsDto>> Handle(StudentAnalyticsQuery request, CancellationToken cancellationToken)
    {
        try
        {
            var dto = await GetStudentAnalyticsAsync(request.StudentId);
            return dto != null
                ? Result<StudentAnalyticsDto>.Success(dto)
                : Result<StudentAnalyticsDto>.Failure("Student not found or invalid role.");
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Error getting student analytics for {StudentId}", request.StudentId);
            return Result<StudentAnalyticsDto>.Failure($"An error occurred while fetching analytics: {ex.Message}");
        }
    }
...
// DTOs remain the same as in your original code...
...
public class StudentAnalyticsDto
{
    ...
    public AssignmentAnalyticsDto AssignmentAnalytics { get; set; }
...
public class StudentProfileDto
{
    ...
    public List<DeviceDto> RegisteredDevices { get; set; }
}
...
public class AssignmentAnalyticsDto
{
    ...
    public List<AssignmentSubmissionDto> RecentSubmissions { get; set; }
    public AssignmentPerformanceDto Performance { get; set; }
}
...
public class ExamAnalyticsDto
{
    ...
    public List<ExamSessionDetailDto> RecentSessions { get; set; }
    public QuestionAnalyticsDto QuestionAnalytics { get; set; }
}
...
public class QuestionAnalyticsDto
{
    ...
    public Dictionary<string, QuestionTypePerformanceDto> PerformanceByType { get; set; }
...
public class PerformanceMetricsDto
{
    ...
    public int StudyStreak { get; set; } // Days
    public DateTimeOffset LastActivityDate { get; set; }
    public Dictionary<string, decimal> GradeDistribution { get; set; }
...
public class ComparisonMetricsDto
{
    ...
    public string ComparedToAverage { get; set; } // Above, At, Below
...
public class TimelineEventDto
{
    ...
    public string Type { get; set; } // Assignment, Quiz, Course, Achievement
